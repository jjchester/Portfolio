...
const SwiftIcon = ({ width = "24px", height = "24px", color }: Props) => {
    const fillColor = useColorModeValue("#000000", "#FFFFFF"); // Default to black in light mode and white in dark mode

    return (
        <Box as="svg" width={width} height={height} viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" fill={color || fillColor}>
